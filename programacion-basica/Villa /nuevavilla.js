...
function dibujar(){
  ...
  if(pollo.cargaOK == true){
    ...
    {
    var x = animales(320, 100);
    var y = animales(320, 100);
  ...
  if(vaca.cargaOK == true){
    ...
    console.log(cantidad)
    for(var v=0; v < cantidad; v++) {
      var x = animales(420, 250);
      var y = animales(420, 250);
  ...
  if(cerdo.cargaOK == true){
    console.log(cantidad)
    for(var v=0; v < cantidad; v++){
      var x = animales(0, 420);
      var y = animales(0, 420);
